...
if (!ref) {
    const latestRelease = await fetch("https://api.github.com/repos/Splashcard04/KeyMapper/releases/latest", {
        headers: {
...
// now copy to path
const ignoredFiles = ["setup", ".git", "README.md", "Examples.md", "files", "LICENSE"]
...
console.log(`Successfully setup KeyMapper at ${destFolder}`)